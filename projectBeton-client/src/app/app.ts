...
const SEO_PRESETS: Record<string, SeoPreset> = {
  '/': {
    ...
    ogTitle: 'Бетон с доставкой в Иваново - цена за куб | Бетон-Строй',
    ogDescription:
  ...
  '/price': {
    ...
    ogTitle: 'Цены на бетон в Иваново за 1 м3 | Бетон-Строй',
    ogDescription:
  ...
  '/services': {
    ...
    ogTitle: 'Доставка и подача бетона в Иваново | Бетон-Строй',
    ogDescription:
      'Организуем доставку бетона и подачу смеси на объект. Подбор техники под условия площадки и задачи строительства.',
  },
  '/contacts': {
    description:
      'Контакты Бетон-Строй: телефон отдела продаж, email, адрес и режим работы. Работаем по Иваново и Ивановской области.',
    ogTitle: 'Контакты бетонного завода | Бетон-Строй',
    ogDescription:
  ...
  '/useful': {
    ...
    ogTitle: 'Полезные материалы о бетоне | Бетон-Строй',
    ogDescription:
  ...
  '/beton-v/:city': {
    ...
    ogTitle: 'Бетон с доставкой по Ивановской области | Бетон-Строй',
    ogDescription:
...
export class App {
  ...
  protected readonly appTitle = signal('Бетон-Строй');
